...
//     const id_produit = await produitModel.createProduit({ nom, description, prix, quantite, id_vendeur: null }, conn);
    
//     // await produitModel.createProduitFournisseur({ id_produit, id_fournisseur, reference_fournisseur, prix_achat }, conn);
...
//     await produitModel.deleteProduit(id, conn);
...
//     await produitModel.updateProduit(id, { nom, description, prix, quantite, id_vendeur }, conn);
    
//     await produitModel.updateProduitFournisseur(id, { id_fournisseur, reference_fournisseur, prix_achat }, conn);
